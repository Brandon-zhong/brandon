package com.demo.webmagic.zhihu;
...
public class ZhihuPageProcesser implements PageProcessor {
    ...
    //设置重试次数，超时时间，编码
    private Site site = Site.me().setRetryTimes(10).setSleepTime(5000).setTimeOut(5000).addCookie("Domain", "zhihu.com").addCookie("z_c0", "2|1:0|10:1514447557|4:z_c0|92:Mi4xd1NYSkJBQUFBQUFBa0NHYkp4cm5EQ2NBQUFDRUFsVk54QzlzV2dCalJ4LWRUOHhLMVJLMmFndTZrc3ZBdF9xRkxn|ba62c51f070c150b87cfd3aa0b882a258887d326320cd21e04bd441399b70d28").setUserAgent("Mozilla/5.0 (Windows NT 6.1; WOW64)AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.89 Safari/537.36");
    ...
    private static String questionId = "37787176";
            ...
            urlList.forEach(url -> {
                if (!url.contains("data")) {
                    try {
                        ...
                        downloadPicture(url, filePath, Integer.toString(random.nextInt()>>>1)
